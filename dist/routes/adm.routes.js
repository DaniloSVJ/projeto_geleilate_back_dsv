    ...
    return __generator(this, function (_b) {
        switch (_b.label) {
            case 0:
                ...
                return [4 /*yield*/, updateUser.update(id, name, email, "admin", birthday, cpf_cnpj, phone, whatsapp, zipcode, state, city, district, region, address, ad_number, status)];
            case 1:
                user = _b.sent();
                userWithoutPassword = {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                ...
                return [4 /*yield*/, viewUsers.getAllAdm()];
            case 1:
                user = _a.sent();
