...
users_bv_Router.post('/', function (request, response) { return __awaiter(void 0, void 0, void 0, function () {
    var _a, name, email, password, user_type, birthday, cpf_cnpj, phone, whatsapp, zipcode, state, city, district, region, address, ad_number, createUser, user, userWithoutPassword;
    return __generator(this, function (_b) {
        switch (_b.label) {
            case 0:
                _a = request.body, name = _a.name, email = _a.email, password = _a.password, user_type = _a.user_type, birthday = _a.birthday, cpf_cnpj = _a.cpf_cnpj, phone = _a.phone, whatsapp = _a.whatsapp, zipcode = _a.zipcode, state = _a.state, city = _a.city, district = _a.district, region = _a.region, address = _a.address, ad_number = _a.ad_number;
...
users_bv_Router.patch('/:id', function (request, response) { return __awaiter(void 0, void 0, void 0, function () {
    var id, _a, name, email, user_type, birthday, cpf_cnpj, phone, whatsapp, zipcode, state, city, district, region, address, ad_number, status, updateUser, user, userWithoutPassword;
    return __generator(this, function (_b) {
        switch (_b.label) {
            case 0:
                id = request.params.id;
                _a = request.body, name = _a.name, email = _a.email, user_type = _a.user_type, birthday = _a.birthday, cpf_cnpj = _a.cpf_cnpj, phone = _a.phone, whatsapp = _a.whatsapp, zipcode = _a.zipcode, state = _a.state, city = _a.city, district = _a.district, region = _a.region, address = _a.address, ad_number = _a.ad_number, status = _a.status;
                updateUser = new CreateUserService_1.default();
                return [4 /*yield*/, updateUser.update(id, name, email, user_type, birthday, cpf_cnpj, phone, whatsapp, zipcode, state, city, district, region, address, ad_number, status)];
            case 1:
                user = _b.sent();
                userWithoutPassword = {
                    id: user.id,
